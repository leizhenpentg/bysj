...
tf.app.flags.DEFINE_integer('charset_size', 11, "Choose the first `charset_size` character to conduct our experiment.")
tf.app.flags.DEFINE_integer('image_size', 64, "Needs to provide same value as in training.")
tf.app.flags.DEFINE_boolean('gray', True, "whether to change the rbg to gray")
tf.app.flags.DEFINE_integer('max_steps', 2002, 'the max training steps ')
...
tf.app.flags.DEFINE_string('train_data_dir', 'H:/why_workspace/char_data/train2/', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', 'H:/why_workspace/char_data/test2/', 'the test dataset dir')
...
def train():
    ...
    train_feeder = DataIterator(data_dir='H:/why_workspace/char_data/train2/')
