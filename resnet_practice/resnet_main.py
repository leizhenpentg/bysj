...
tf.app.flags.DEFINE_integer('charset_size', 94, "Choose the first `charset_size` character to conduct our experiment.")
...
tf.app.flags.DEFINE_string('train_data_dir', 'H:/why_workspace/char_classify/resnet_practice/94/train/', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', 'H:/why_workspace/char_classify/resnet_practice/94/test/', 'the test dataset dir')
tf.app.flags.DEFINE_string('val_data_dir', 'H:/why_workspace/char_classify/resnet_practice/94/val/', 'the val dataset dir')
tf.app.flags.DEFINE_string('log_dir', './log', 'the logging dir')

tf.app.flags.DEFINE_boolean('restore', True, 'whether to restore from checkpoint')
tf.app.flags.DEFINE_integer('epoch', 40, 'Number of epoches')
...
def get_batch2(dirpath =  '',is_train=''):
...
def build_graph(num_classes=FLAGS.charset_size, top_k=3, is_training=''):
    ...
    rate = tf.train.exponential_decay(0.0001, global_step, decay_steps=437, decay_rate=0.997, staircase=True)
...
def train():
    ...
    with sess:
        train_images, train_labels = get_batch2(dirpath=FLAGS.train_data_dir, is_train='train')
        test_images, test_labels = get_batch2(dirpath=FLAGS.test_data_dir, is_train='test')
        val_images, val_labels = get_batch2(dirpath=FLAGS.test_data_dir, is_train='val')
